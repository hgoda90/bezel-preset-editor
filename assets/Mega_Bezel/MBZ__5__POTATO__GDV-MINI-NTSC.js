let settingDefinitions = [
    ...
    {
        header: "[ GDV MINI - DariusG ]:",
        settings: [
        { key: "brightboost", label: "Bright boost -- brightboost", default: 1.000000, min: 0.50, max: 2.00, step: 0.05 },
        { key: "saturation", label: "Saturation adjustment -- saturation", default: 1.000000, min: 0.00, max: 2.00, step: 0.05 },
        { key: "scanline", label: "Scanline Adjust -- scanline", default: 8.000000, min: 1.00, max: 12.00, step: 1.00 },
        { key: "beam_min", label: "Scanline Dark -- beam_min", default: 1.700000, min: 0.50, max: 3.00, step: 0.05 },
        { key: "beam_max", label: "Scanline Bright -- beam_max", default: 2.100000, min: 0.50, max: 3.00, step: 0.05 },
        { key: "h_sharp", label: "Horizontal Sharpness -- h_sharp", default: 2.000000, min: 1.00, max: 5.00, step: 0.05 },
        { key: "shadowMask", label: "CRT Mask: 0:CGWG, 1-4:Lottes, 5-6:Trinitron", default: 0.000000, min: -1.00, max: 10.00, step: 1.00 },
        { key: "masksize", label: "Mask Size - 0:Auto | 2K | 4k -- masksize", default: 1.000000, min: 0.00, max: 4.00, step: 1.00 },
        { key: "mcut", label: "Mask 5-7-10 cutoff -- mcut", default: 0.200000, min: 0.00, max: 0.50, step: 0.05 },
        { key: "maskDark", label: "Lottes maskDark", default: 0.500000, min: 0.00, max: 2.00, step: 0.10 },
        { key: "maskLight", label: "Lottes maskLight", default: 1.500000, min: 0.00, max: 2.00, step: 0.10 },
        { key: "CGWG", label: "CGWG Mask Str. -- CGWG", default: 0.400000, min: 0.00, max: 1.00, step: 0.10 },
        { empty_row: true }
        ]
    },
    {
