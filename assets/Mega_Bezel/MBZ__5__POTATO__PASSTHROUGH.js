let settingDefinitions = [
    ...
    {
        header: "[ --- SCREEN SCALE G-SHARP RESAMPLER by Guest.r --- ]:",
        settings: [
        { key: "HSM_SCREEN_SCALE_GSHARP_MODE", label: "G-SHARP MODE: OFF | SHARP | EDITABLE", default: 1.000000, min: 0.00, max: 2.00, step: 1.00 },
        { key: "HSM_SCREEN_SCALE_HSHARP0", label: "Filter Range", default: 1.000000, min: 1.00, max: 6.00, step: 0.10 },
        { key: "HSM_SCREEN_SCALE_SIGMA_HV", label: "Gaussian Blur Sigma", default: 0.250000, min: 0.10, max: 7.00, step: 0.05 },
        { key: "HSM_SCREEN_SCALE_SHAR", label: "Sharpness Definition", default: 0.000000, min: 0.00, max: 2.00, step: 0.05 },
        { key: "HSM_SCREEN_SCALE_HAR", label: "Anti-Ringing", default: 0.500000, min: 0.00, max: 1.00, step: 0.10 },
        { empty_row: true }
        ]
    },
    {
