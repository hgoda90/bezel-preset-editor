let settingDefinitions = [
    ...
    },
    {
        header: "[ SCANLINE ]:",
        settings: [
        { key: "ESM_SCANLINE_STRENGTH_MIN", label: "Strength Min.", default: 0.200000, min: 0.00, max: 1.00, step: 0.05 },
        { key: "ESM_SCANLINE_STRENGTH_MAX", label: "Strength Max.", default: 0.400000, min: 0.00, max: 1.00, step: 0.05 },
        { key: "ESM_SCANLINE_BEAM_MIN", label: "Beam Min.", default: 1.000000, min: 0.25, max: 5.00, step: 0.05 },
        { key: "ESM_SCANLINE_BEAM_MAX", label: "Beam Max.", default: 1.000000, min: 0.25, max: 5.00, step: 0.05 },
        { empty_row: true }
        ]
    },
    {
        header: "[ SHARPNESS ]:",
        settings: [
        { key: "ESM_SHARPNESS_H", label: "Horizontal", default: 0.600000, min: 0.00, max: 1.00, step: 0.05 },
        { key: "ESM_SHARPNESS_V", label: "Vertical", default: 1.000000, min: 0.00, max: 1.00, step: 0.05 },
        { empty_row: true }
        ]
    },
    {
        header: "[ MASK ]:",
        settings: [
        { key: "ESM_MASK_TYPE", label: "Type", default: 4.000000, min: 0.00, max: 7.00, step: 1.00 },
        { key: "ESM_MASK_SIZE", label: "Size - 0:Auto, 1:2K, 2:4K", default: 0.000000, min: 0.00, max: 100.00, step: 1.00 },
        { key: "ESM_MASK_STRENGTH_MIN", label: "Strength Min.", default: 0.200000, min: 0.00, max: 0.50, step: 0.01 },
        { key: "ESM_MASK_STRENGTH_MAX", label: "Strength Max.", default: 0.200000, min: 0.00, max: 0.50, step: 0.01 },
        { empty_row: true }
        ]
    },
    {
        header: "[ GLOW ]:",
        settings: [
        { key: "ESM_HALATION", label: "Halation", default: 0.030000, min: 0.00, max: 1.00, step: 0.01 },
        { key: "ESM_DIFFUSION", label: "Diffusion", default: 0.000000, min: 0.00, max: 1.00, step: 0.01 },
        { key: "ESM_BRIGHTNESS", label: "Brightness", default: 0.730000, min: 0.00, max: 2.00, step: 0.01 },
        { empty_row: true }
        ]
    },
    {
