let settingDefinitions = [
    ...
    {
        header: "[ SUBPIXEL COLORS ]:",
        settings: [
        { key: "LCD_RSUBPIX_R", label: "Colour of R subpixel: R", default: 0.750000, min: 0.00, max: 1.00, step: 0.01 },
        { key: "LCD_RSUBPIX_G", label: "Colour of R subpixel: G", default: 0.000000, min: 0.00, max: 1.00, step: 0.01 },
        { key: "LCD_RSUBPIX_B", label: "Colour of R subpixel: B", default: 0.000000, min: 0.00, max: 1.00, step: 0.01 },
        { key: "LCD_GSUBPIX_R", label: "Colour of G subpixel: R", default: 0.000000, min: 0.00, max: 1.00, step: 0.01 },
        { key: "LCD_GSUBPIX_G", label: "Colour of G subpixel: G", default: 0.750000, min: 0.00, max: 1.00, step: 0.01 },
        { key: "LCD_GSUBPIX_B", label: "Colour of G subpixel: B", default: 0.000000, min: 0.00, max: 1.00, step: 0.01 },
        { key: "LCD_BSUBPIX_R", label: "Colour of B subpixel: R", default: 0.000000, min: 0.00, max: 1.00, step: 0.01 },
        { key: "LCD_BSUBPIX_G", label: "Colour of B subpixel: G", default: 0.000000, min: 0.00, max: 1.00, step: 0.01 },
        { key: "LCD_BSUBPIX_B", label: "Colour of B subpixel: B", default: 0.750000, min: 0.00, max: 1.00, step: 0.01 },
        { empty_row: true }
        ]
    },
    {
        ...
        settings: [
        { key: "LCD_GAIN", label: "Gain", default: 1.300000, min: 0.50, max: 2.00, step: 0.05 },
        { key: "LCD_GAMMA", label: "LCD Gamma", default: 2.500000, min: 0.50, max: 5.00, step: 0.10 },
        { key: "LCD_AMBIENT", label: "Ambient", default: 0.000000, min: 0.00, max: 25.00, step: 0.10 },
        { key: "LCD_BGR", label: "BGR LCD Sub Pixel Order", default: 0.000000, min: 0.00, max: 1.00, step: 1.00 },
        { empty_row: true }
        ]
    },
    {
