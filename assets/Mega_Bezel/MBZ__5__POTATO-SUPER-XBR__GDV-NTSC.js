let settingDefinitions = [
    ...
    },
    {
        ...
        { key: "HSM_CRT_SCREEN_BLEND_MODE", label: "CRT POTATO Blend Mode - OFF | NORMAL | ADD (Backdrop)", default: 1.000000, min: 0.00, max: 2.00, step: 1.00 }
        ]
    },
    {
        header: "[ POTATO BACKGROUND IMAGE LAYER ]:",
        settings: [
        { key: "HSM_POTATO_SHOW_BG_OVER_SCREEN", label: "Show BG: 0:UNDER SCREEN | 1:OVER SCREEN", default: 1.000000, min: 0.00, max: 1.00, step: 1.00 },
        { key: "HSM_BG_BLEND_MODE", label: "Blend Mode - OFF | NORMAL | ADD | MULTIPLY", default: 1.000000, min: -1.00, max: 3.00, step: 1.00 },
        { key: "HSM_POTATO_COLORIZE_CRT_WITH_BG", label: "Colorize CRT with BG", default: 0.000000, min: 0.00, max: 100.00, step: 1.00 },
        { key: "HSM_POTATO_COLORIZE_BRIGHTNESS", label: "Colorize Brightness", default: 100.000000, min: 0.00, max: 1000.00, step: 10.00 },
    ...
    {
        header: "[ --- SUPER-XBR by HYLLIAN --- ]:",
        settings: [
        { key: "SUPERXBR_ON", label: "Super-XBR ON", default: 1.000000, min: 0.00, max: 1.00, step: 1.00 },
        { key: "MODE", label: "Mode - Normal, Details, Adaptive", default: 1.000000, min: 0.00, max: 2.00, step: 1.00 },
        { key: "XBR_EDGE_STR_P0", label: "Xbr - Edge Strength p0", default: 1.000000, min: 0.00, max: 5.00, step: 0.50 },
        { key: "XBR_WEIGHT", label: "Xbr - Filter Weight", default: 0.000000, min: 0.00, max: 1.00, step: 0.10 },
        { key: "XBR_EDGE_SHP", label: "Adaptive Dynamic Edge Sharp", default: 0.400000, min: 0.00, max: 3.00, step: 0.10 },
        { key: "XBR_TEXTURE_SHP", label: "Adaptive Static Edge Sharp", default: 1.000000, min: 0.00, max: 2.00, step: 0.10 },
        { key: "XBR_EDGE_STR_P1", label: "Xbr - Edge Strength p1", default: 1.000000, min: 0.00, max: 5.00, step: 0.50 },
        { key: "XBR_EDGE_STR_P2", label: "Xbr - Edge Strength p2", default: 1.000000, min: 0.00, max: 5.00, step: 0.50 },
        { empty_row: true }
        ]
    },
    {
    ...
    },
    {
        header: "[ NTSC QUALITY ]:",
        settings: [
        { key: "quality", label: "INFO:  Fringe & Artifact Values: Svideo 0 | Composite 1 | RF 2", default: 0.000000, min: 0.00, max: 0.00, step: 1.00 },
        { key: "cust_artifacting", label: "Artifacting Value", default: 1.000000, min: 0.00, max: 5.00, step: 0.10 },
        { key: "cust_fringing", label: "Fringing Value", default: 1.000000, min: 0.00, max: 5.00, step: 0.10 }
        ]
    },
    {
        header: "[ NTSC FIELDS & PHASE ]:",
        settings: [
        { key: "ntsc_fields", label: "Merge Fields: Auto | NO | YES", default: -1.000000, min: -1.00, max: 1.00, step: 1.00 },
        { key: "ntsc_phase", label: "Phase: Auto | 2 phase | 3 phase | Mixed", default: 1.000000, min: 1.00, max: 4.00, step: 1.00 },
        { key: "ntsc_scale", label: "Resolution Scaling", default: 1.000000, min: 0.20, max: 2.50, step: 0.03 }
        ]
    },
    {
        header: "[ NTSC COLOR & BRIGHTNESS]:",
        settings: [
        { key: "ntsc_cscale", label: "Chroma Scaling / Bleeding", default: 1.000000, min: 0.20, max: 4.00, step: 0.05 },
        { key: "ntsc_sat", label: "Color Saturation", default: 1.000000, min: 0.00, max: 2.00, step: 0.01 },
        { key: "ntsc_bright", label: "Brightness", default: 1.000000, min: 0.00, max: 1.50, step: 0.01 },
        { key: "ntsc_gamma", label: "NTSC Filtering Gamma Correction", default: 1.000000, min: 0.25, max: 2.00, step: 0.03 },
        { key: "ntsc_ring", label: "Anti-Ringing", default: 0.500000, min: 0.00, max: 1.00, step: 0.10 },
        { empty_row: true }
        ]
    },
    {
        header: "[ NTSC SHARPNESS ]:",
        settings: [
        { key: "ntsc_sharp", label: "Sharpness (Negative: Adaptive)", default: 0.000000, min: -10.00, max: 10.00, step: 0.50 },
        { key: "ntsc_shape", label: "Sharpness Shape", default: 0.750000, min: 0.50, max: 1.00, step: 0.05 },
    ...
    },
    {
        ...
        settings: [
        { key: "HSHARPNESS", label: "NTSC Horizontal Filter Range -- HSHARPNESS", default: 1.600000, min: 1.00, max: 8.00, step: 0.05 },
        { key: "SIGMA_HOR", label: "Horizontal Blur Sigma -- SIGMA_HOR", default: 0.800000, min: 0.10, max: 7.00, step: 0.03 },
        { key: "S_SHARP", label: "Substractive Sharpness -- S_SHARP", default: 1.200000, min: 0.00, max: 3.00, step: 0.05 },
        { key: "HSHARP", label: "Sharpness Definition -- HSHARP", default: 1.200000, min: 0.00, max: 2.00, step: 0.10 },
        { key: "MAXS", label: "Maximum Sharpness", default: 0.180000, min: 0.00, max: 0.30, step: 0.01 },
        { key: "HARNG", label: "Substractive Sharpness Ringing -- HARNG", default: 0.300000, min: 0.00, max: 4.00, step: 0.05 },
    ...
    },
    {
        ...
        { key: "scangamma", label: "Scanline Gamma -- scangamma", default: 2.400000, min: 0.50, max: 5.00, step: 0.05 },
        { empty_row: true }
        ]
    },
    {
    ...
    },
    {
        ...
        { key: "BackgroundImage", path: "../../../shaders/textures/Baked_Frame_Carbonfiber_Background.png" },
        { key: "BackgroundVertImage", path: "../../../shaders/textures/Baked_Frame_Carbonfiber_Background_Vert.png" }
        ]
    }
];