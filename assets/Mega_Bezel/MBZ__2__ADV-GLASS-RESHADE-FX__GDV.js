let settingDefinitions = [
    ...
    },
    {
        ...
        { key: "bLensdirtEnable_toggle", label: "Lens Dirt Enable", default: 0.000000, min: 0.00, max: 1.00, step: 1.00 },
        { key: "bAnamFlareEnable_toggle", label: "Anam Flare Enable", default: 0.000000, min: 0.00, max: 1.00, step: 1.00 },
        { key: "bLenzEnable_toggle", label: "Lenz Enable", default: 0.000000, min: 0.00, max: 1.00, step: 1.00 },
        { key: "bChapFlareEnable_toggle", label: "Chap Flare Enable", default: 0.000000, min: 0.00, max: 1.00, step: 1.00 },
        { key: "bGodrayEnable_toggle", label: "Godray Enable", default: 0.000000, min: 0.00, max: 1.00, step: 1.00 },
        { key: "iBloomMixmode", label: "Bloom Mix Mode", default: 0.000000, min: 0.00, max: 2.00, step: 1.00 },
        { key: "fBloomThreshold", label: "Bloom Threshold", default: 0.800000, min: 0.10, max: 1.00, step: 0.10 },
        { key: "fBloomAmount", label: "Bloom Amount", default: 0.800000, min: 0.00, max: 20.00, step: 0.10 },
        { key: "fBloomSaturation", label: "Bloom Saturation", default: 0.800000, min: 0.00, max: 2.00, step: 0.10 },
        { key: "fBloomTint_r", label: "Bloom Tint R", default: 0.700000, min: 0.00, max: 1.00, step: 0.05 },
        { key: "fBloomTint_g", label: "Bloom Tint G", default: 0.800000, min: 0.00, max: 1.00, step: 0.05 },
        { key: "fBloomTint_b", label: "Bloom Tint B", default: 1.000000, min: 0.00, max: 1.00, step: 0.05 },
        { key: "iLensdirtMixmode", label: "Lens Dirt Mix Mode", default: 0.000000, min: 0.00, max: 3.00, step: 1.00 },
        { key: "fLensdirtIntensity", label: "Lens Dirt Intensity", default: 0.400000, min: 0.00, max: 2.00, step: 0.10 },
        { key: "fLensdirtSaturation", label: "Lens Dirt Saturation", default: 2.000000, min: 0.00, max: 2.00, step: 0.10 },
        { key: "fLensdirtTint_r", label: "Lens Dirt Tint R", default: 1.000000, min: 0.00, max: 1.00, step: 0.05 },
        { key: "fLensdirtTint_g", label: "Lens Dirt Tint G", default: 1.000000, min: 0.00, max: 1.00, step: 0.05 },
        { key: "fLensdirtTint_b", label: "Lens Dirt Tint B", default: 1.000000, min: 0.00, max: 1.00, step: 0.05 },
        { key: "fAnamFlareThreshold", label: "Anam Flare Threshold", default: 0.900000, min: 0.10, max: 1.00, step: 0.10 },
        { key: "fAnamFlareWideness", label: "Anam Flare Width", default: 2.400000, min: 1.00, max: 2.50, step: 0.10 },
        { key: "fAnamFlareAmount", label: "Anam Flare Amt", default: 14.500000, min: 1.00, max: 20.00, step: 0.50 },
        { key: "fAnamFlareCurve", label: "Anam Flare Curve", default: 1.200000, min: 1.00, max: 2.00, step: 0.10 },
        { key: "fAnamFlareColor_r", label: "Anam Flare Col R", default: 0.012000, min: 0.00, max: 1.00, step: 0.01 },
        { key: "fAnamFlareColor_g", label: "Anam Flare Col G", default: 0.313000, min: 0.00, max: 1.00, step: 0.01 },
        { key: "fAnamFlareColor_b", label: "Anam Flare Col B", default: 0.588000, min: 0.00, max: 1.00, step: 0.01 },
        { key: "fLenzIntensity", label: "Lenz Intensity", default: 1.000000, min: 0.20, max: 3.00, step: 0.10 },
        { key: "fLenzThreshold", label: "Lenz Threshold", default: 0.800000, min: 0.60, max: 1.00, step: 0.10 },
        { key: "fChapFlareThreshold", label: "Chap Flare Threshold", default: 0.900000, min: 0.70, max: 0.99, step: 0.05 },
        { key: "iChapFlareCount", label: "Chap Flare Count", default: 15.000000, min: 1.00, max: 20.00, step: 1.00 },
        { key: "fChapFlareDispersal", label: "Chap Flare Dispersal", default: 0.250000, min: 0.25, max: 1.00, step: 0.05 },
        { key: "fChapFlareSize", label: "Chap Flare Size", default: 0.450000, min: 0.20, max: 0.80, step: 0.05 },
        { key: "fChapFlareCA_r", label: "Chap Flare CA R", default: 0.000000, min: 0.00, max: 1.00, step: 0.01 },
        { key: "fChapFlareCA_g", label: "Chap Flare CA G", default: 0.010000, min: 0.00, max: 1.00, step: 0.01 },
        { key: "fChapFlareCA_b", label: "Chap Flare CA B", default: 0.020000, min: 0.00, max: 1.00, step: 0.01 },
        { key: "fChapFlareIntensity", label: "Chap Flare Intensity", default: 100.000000, min: 5.00, max: 200.00, step: 5.00 },
        { key: "fGodrayDecay", label: "Godray Decay", default: 0.990000, min: 0.50, max: 1.00, step: 0.05 },
        { key: "fGodrayExposure", label: "Godray Exposure", default: 1.000000, min: 0.70, max: 1.50, step: 0.05 },
        { key: "fGodrayWeight", label: "Godray Weight", default: 1.250000, min: 0.80, max: 1.70, step: 0.05 },
        { key: "fGodrayDensity", label: "Godray Density", default: 1.000000, min: 0.20, max: 2.00, step: 0.20 },
        { key: "fGodrayThreshold", label: "Godray Threshold", default: 0.900000, min: 0.60, max: 1.00, step: 0.05 },
        { key: "iGodraySamples", label: "Godray Samples", default: 128.000000, min: 16.00, max: 256.00, step: 16.00 },
        { key: "fFlareLuminance", label: "Flare Luminance", default: 0.095000, min: 0.00, max: 1.00, step: 0.01 },
        { key: "fFlareBlur", label: "Flare Blur", default: 200.000000, min: 1.00, max: 10000.00, step: 50.00 },
        { key: "fFlareIntensity", label: "Flare Intensity", default: 2.070000, min: 0.20, max: 5.00, step: 0.10 },
        { key: "fFlareTint_r", label: "Flare Tint R", default: 0.137000, min: 0.00, max: 1.00, step: 0.05 },
        { key: "fFlareTint_g", label: "Flare Tint G", default: 0.216000, min: 0.00, max: 1.00, step: 0.05 },
        { key: "fFlareTint_b", label: "Flare Tint B", default: 1.000000, min: 0.00, max: 1.00, step: 0.05 },
        { empty_row: true }
        ]
    },
    {
